...
import com.vkcrestore.Survey.SurveySetModel;
...
public class VkcAPIRetrofit implements IVkcApis {
    ...
    public VkcAPIRetrofit(Context context) {
    ...
    public void gpsApi(GpsModel gpsModel) {
        ...
        try {
            ...
            System.out
                    .println("jStringContacts values gps send" + json_Response_Str);

            System.out
                    .println("jStringContacts values gps lat" + gpsModel
                            .getLatitude());
            System.out
                    .println("jStringContacts values gps lng" + gpsModel
                            .getLongitude());

            System.out
                    .println("jStringContacts values gps user" + gpsModel
                            .getUser_id());

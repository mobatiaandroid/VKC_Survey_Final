...
*/
    ...
    /* new live url */
//Local
   /* String DOMAIN_VKC = "http://192.168.0.153/vkcsurveyV2/api/";
    String IMAGE_FEEDBACK_URL = "http://192.168.0.167/vkcsurveyV2/";
    String DOMAIN_IMAGE_UPLOAD = "http://192.168.0.167/vkcsurveyV2/api/upload";*/
//

   /*String DOMAIN_VKC = "http://192.168.0.153/vkcsurveyV2/api/";

    String DOMAIN_IMAGE_UPLOAD = "http://192.168.0.153/vkcsurveyV2/api/upload";*/
    /*String
            IMAGE_FEEDBACK_URL = "https://survey.walkaroo.in/";*/
    String DOMAIN_VKC = "https://survey.walkaroo.in/api/";
    String
            IMAGE_FEEDBACK_URL = "https://survey.walkaroo.in/";
    String
            DOMAIN_IMAGE_UPLOAD = "https://survey.walkaroo.in/api/upload";
    ...
    String IMAGE_FEEDBACK_URL = "http://dev.mobatia.com/vkcsurveyV2/";
    String DOMAIN_IMAGE_UPLOAD = "http://dev.mobatia.com/vkcsurveyV2/api/upload";*/
    //String DOMAIN_VKC = "http://192.168.0.231/vkcsurvey_attendance/api/";
    /*String DOMAIN_VKC = "http://dev.mobatia.com/vkcsurveyV2/api/";
    String IMAGE_FEEDBACK_URL = "http://dev.mobatia.com/vkcsurveyV2/";
    String DOMAIN_IMAGE_UPLOAD = "http://dev.mobatia.com/vkcsurveyV2/api/upload";*/

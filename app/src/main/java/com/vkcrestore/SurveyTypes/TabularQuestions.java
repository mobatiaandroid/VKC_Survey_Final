...
public class TabularQuestions extends Activity {
	...
	// ArrayList<ArrayList<ArrayList<String>>> selectedList = new
	// ArrayList<ArrayList<ArrayList<String>>>();
	// ArrayList<TabularSurverySelected>selectedList=new
	// ArrayList<TabularSurverySelected>();
	ArrayList<String> selectedList = new ArrayList<String>();
	String[][] selectedListArray = new String[40][40];
	ArrayList<String> subOpArray = new ArrayList<String>();
	String[] newArray;
	Survey survey;
	// GridView subLayout;
		...
		addOption.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (selectedList.size() == 0
					...
					alertbox("Error", "Please fill all the data to add new arow");
				}
				else
				{
					getDataFromDb2();
